...
#define WINDOW_TITLE TEXT("SNES Emu Ai")

// the windows registry is no longer used
//#define MY_REG_KEY   "Software\\Emulators\\Snes9x"
//#define REG_KEY_VER  "1.31"

#define DISCLAIMER_TEXT        TEXT("SNES Emu Ai v%s for Windows.\r\n\
Based on snes9x - Portable Super Nintendo Entertainment System (TM) emulator.\r\n\r\n\
Original snes9x developers:\r\n\
...
SNES Emu Ai:\r\n\
(c) Copyright 2026  Hazim Batwa\r\n\r\n\
Windows Port Authors: Matthew Kendora, funkyass, nitsuja, Nach, blip, OV2.\r\n\r\n\
SNES Emu Ai is a Super Nintendo Entertainment System\r\n\
emulator that allows you to play most games designed\r\n\
for the SNES on your PC.\r\n\r\n\
Nintendo is a trademark.")


#define APP_NAME TEXT("SNES Emu Ai")
// possible global strings
#define SNES_EMU_AI_INFO TEXT("SNES Emu Ai: Information")
#define SNES_EMU_AI_WARN TEXT("SNES Emu Ai: WARNING!")
#define SNES_EMU_AI_DXS TEXT("SNES Emu Ai: DirectSound")
#define SNES_EMU_AI_SNDQ TEXT("SNES Emu Ai: Sound CPU Question")
#define SNES_EMU_AI_NP_ERROR TEXT("SNES Emu Ai: NetPlay Error")
...
#define HOTKEYS_LABEL_1_11 TEXT("Quit SNES Emu Ai:")
...
#define WINPROC_FILTER_RESTART "You will need to restart SNES Emu Ai before the output image\nprocessing option change will take effect."
...
#define MOVIE_FILETYPE_DESCRIPTION TEXT("SNES Emu Ai Movie File")
...
#define MOVIE_ERR_WRONG_VERSION MOVIE_ERR_WRONG_VERSION_SHORT TEXT(" You need a different version of SNES Emu Ai to play this movie.")
...
#define SEARCH_TITLE_CHEATERROR TEXT("SNES Emu Ai Cheat Error")
